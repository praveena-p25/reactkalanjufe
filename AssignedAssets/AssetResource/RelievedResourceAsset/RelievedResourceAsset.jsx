...
import {
  allocateAsset,
  getAllRelievedResourceAssets,
  returnAsset,
} from "../../../../Api/assets";
import checkSvg from "../../../../assets/check.svg";
import eyeIconSvg from "../../../../assets/eyeIcon.svg";
import classes from "./RelievedResourceAsset.module.css";
...
const RelievedResourceAsset = (props) => {
  ...
  const handlePagination = ({ currentPagination, perPage }) => {
  ...
  const fetchTableData = async () => {
    const { data } = await getAllRelievedResourceAssets({
  ...
  return (
    <div className={classes.RelievedResourceAsset}>
      <SearchFilter
        page={"client"}
...
export default RelievedResourceAsset;
